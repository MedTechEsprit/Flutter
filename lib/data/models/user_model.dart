...
class PatientModel extends UserModel {
  ...
  factory PatientModel.fromJson(Map<String, dynamic> json) {
    ...
    if (td == 'TYPE_1')
      ...
      diabetesType = 'Type 2';
    else if (td == 'GESTATIONNEL')
      diabetesType = 'Gestationnel';
    else if (td == 'PRE_DIABETE')
      diabetesType = 'Pré-diabète';
    else if (td == 'AUTRE')
      diabetesType = 'Autre';
    else if (td.isNotEmpty)
      diabetesType = td;
    ...
    return PatientModel(
      ...
      avatarUrl: json['photoProfil']?.toString(),
      age: age,
      diabetesType: diabetesType,
      bloodType: json['groupeSanguin']?.toString() ?? '-',
      status: 'Stable',
      emergencyContact: med['contactUrgence']?.toString(),
      diagnosisDate: med['dateDiagnostic'] != null
          ? DateTime.tryParse(med['dateDiagnostic'].toString())
          : null,
