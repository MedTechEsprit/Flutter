      ...
      if (result['success'] == true) {
        ...
        _pharmacies = rawList.map((json) {
          ...
          return PharmacyUserModel(
            ...
            email: map['email']?.toString() ?? '',
            phone:
                map['telephonePharmacie']?.toString() ??
                map['telephone']?.toString() ??
                '',
            avatarUrl:
                map['photoProfil']?.toString() ??
