...
class _FindPharmaciesScreenState extends State<FindPharmaciesScreen> {
  ...
  void initState() {
    super.initState();
    _loadPendingResponses();
  }

  Future<void> _loadPendingResponses() async {
    ...
    try {
      ...
      for (final request in data) {
        ...
        for (final response in responses) {
          final status = response is Map ? response['status']?.toString() : '';
                  ...
                  children: [
                    ...
                    _QuickBtn(
                      ...
                      onTap: () => Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (_) =>
                              const ConversationListScreen(isDoctor: false),
                        ),
                      ),
                    ),
                  ],
