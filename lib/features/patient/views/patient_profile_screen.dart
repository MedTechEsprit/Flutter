...
class PatientProfileScreen extends StatelessWidget {
  ...
  // ── Section builders ──
  Widget _buildGroupedStat({required String label, required String value, required IconData icon, required Color color}) {
    return Column(
      mainAxisSize: MainAxisSize.min,
      children: [
        Row(
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: OutlinedButton.icon(
                        ...
                        label: const Text('Actualiser', style: TextStyle(fontWeight: FontWeight.w700)),
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        label: Text(isActive ? 'Gérer' : 'Souscrire', style: const TextStyle(fontWeight: FontWeight.w700)),
