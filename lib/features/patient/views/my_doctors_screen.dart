...
import 'package:diab_care/features/patient/views/patient_doctor_profile_screen.dart';
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final res = await http
          .get(
            Uri.parse(
              '${AuthService.baseUrl}/api/medecins/patient/$patientId/my-doctors',
            ),
            headers: {
          ...
          ? Center(
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'Vous n\'êtes patient d\'aucun médecin',
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  gradient: LinearGradient(
                                    colors: [
                                      AppColors.softGreen,
                                      AppColors.softGreen.withValues(
                                        alpha: 0.7,
                                      ),
                                    ],
                                  ),
