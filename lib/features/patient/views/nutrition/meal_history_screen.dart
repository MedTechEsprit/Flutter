...
import 'package:diab_care/features/patient/views/nutrition/meal_ai_detail_screen.dart';
...
class _MealHistoryScreenState extends State<MealHistoryScreen> {
  ...
  void _openEdit(BuildContext context, MealEntry entry) {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => MealLoggingScreen(editingEntry: entry)),
    );
  }

  void _openDetails(BuildContext context, MealEntry entry) {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => MealAiDetailScreen(meal: entry)),
    );
  }
