        ...
        slivers: [
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          '${glucoseVM.readings.length} mesures enregistrées',
                          style: TextStyle(
            ...
            child: SingleChildScrollView(
              ...
              child: Row(
                children: [
                  _FilterChip(
                    label: 'Tout',
                    isSelected: glucoseVM.filterType == 'all',
                    onTap: () => glucoseVM.setFilter('all'),
                  ),
                  _FilterChip(
                    label: 'À jeun',
                    isSelected: glucoseVM.filterType == 'fasting',
                    onTap: () => glucoseVM.setFilter('fasting'),
                  ),
                  _FilterChip(
                    label: 'Avant repas',
                    isSelected: glucoseVM.filterType == 'before_meal',
                    onTap: () => glucoseVM.setFilter('before_meal'),
                  ),
                  _FilterChip(
                    label: 'Après repas',
                    isSelected: glucoseVM.filterType == 'after_meal',
                    onTap: () => glucoseVM.setFilter('after_meal'),
                  ),
                  _FilterChip(
                    label: 'Coucher',
                    isSelected: glucoseVM.filterType == 'bedtime',
                    onTap: () => glucoseVM.setFilter('bedtime'),
                  ),
                ],
              ),
            ),
          ...
          ...sortedDates.map((dateStr) {
            ...
            final filteredReadings = glucoseVM.filterType == 'all'
                ? readings
                : readings
                      .where((r) => r.type == glucoseVM.filterType)
                      .toList();
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(
                            '${filteredReadings.length} mesures',
                            style: const TextStyle(
                              fontSize: 12,
                    ...
                    ...filteredReadings.map(
                      (r) => Padding(
                        ...
                        child: GlucoseCard(
                          reading: r,
                          displayUnit: glucoseVM.preferredUnit,
                        ),
                      ),
                    ),
                  ],
