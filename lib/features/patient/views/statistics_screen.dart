          ...
          children: [
            ...
            Row(
              children: [
                Expanded(
                  child: _SummaryCard(
                    title: 'Moyenne',
                    value: vm.preferredUnit == 'mmol/L'
                        ? vm.averageGlucose.toStringAsFixed(1)
                        : '${vm.averageGlucose.toInt()}',
                    unit: vm.preferredUnit,
              ...
              children: [
                Expanded(
                  child: _SummaryCard(
                    title: 'Min',
                    value: vm.preferredUnit == 'mmol/L'
                        ? vm.minGlucose.toStringAsFixed(1)
                        : '${vm.minGlucose.toInt()}',
                    unit: vm.preferredUnit,
                ...
                Expanded(
                  child: _SummaryCard(
                    title: 'Max',
                    value: vm.preferredUnit == 'mmol/L'
                        ? vm.maxGlucose.toStringAsFixed(1)
                        : '${vm.maxGlucose.toInt()}',
                    unit: vm.preferredUnit,
            ...
            _Section(
              ...
              child: GlucoseChartWidget(
                readings: vm.weeklyReadings,
                height: 220,
                displayUnit: vm.preferredUnit,
              ),
            ),
            const SizedBox(height: 20),
