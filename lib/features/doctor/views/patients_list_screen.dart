...
class _PatientsListScreenState extends State<PatientsListScreen> {
          ...
          Container(
            ...
            decoration: const BoxDecoration(
              ...
              borderRadius: BorderRadius.only(
                bottomLeft: Radius.circular(AppColors.headerRadius),
                bottomRight: Radius.circular(AppColors.headerRadius),
              ),
            ),
            child: SafeArea(
              child: Padding(
                  ...
                  children: [
                    ...
                    Text(
                      _isLoading
                          ? 'Loading...'
                          : _statusCounts != null
                          ? '${_statusCounts!.total} patients inscrits'
                          : '0 patients inscrits',
                      style: TextStyle(
                    ...
                    Container(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: 'Rechercher des patients...',
                      ...
                      children: [
                        ...
                        Text(
                          _searchQuery.isNotEmpty
                              ...
                              : 'Commencez par accepter des demandes de patients',
                          style: TextStyle(color: Colors.grey.shade600),
                        ),
                      ],
                    ),
                ...
                : RefreshIndicator(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return _buildPatientCard(context, patient: patient);
                      },
                    ),
                  ),
          ),
  ...
  Widget _buildPatientCard(
    ...
    final profileImage = ProfileImageUtils.imageProvider(patient.photoProfil);
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [AppColors.white, statusColor.withOpacity(0.02)],
        ),
