...
class _PatientDetailViewScreenState extends State<PatientDetailViewScreen>
  ...
  Future<void> _sendAccessRequest() async {
    ...
    try {
      final doctorId = await _tokenService.getUserId();
      if (doctorId == null) throw Exception('Médecin introuvable');
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: const Text(
            'Demande envoyée au patient. En attente de sa réponse.',
          ),
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Accès non autorisé par le patient',
                      ...
                      const Text(
                        'Le patient a désactivé l’accès à ses informations. Envoyez une demande pour obtenir l’autorisation.',
                        textAlign: TextAlign.center,
