            ...
            children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              _isLoading
                                  ? 'Chargement...'
                                  : '${_stats?.total ?? _appointments.length} rendez-vous au total',
                              style: TextStyle(
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      _buildViewToggle('Liste', Icons.list),
                      _buildViewToggle('Calendrier', Icons.calendar_month),
                    ],
                  ),
                ),
              ),
              ...
              if (_stats != null)
                SizedBox(
                  ...
                  child: ListView(
                    ...
                    padding: const EdgeInsets.symmetric(horizontal: 20),
                    children: [
                      _buildFilterChip('Tous', _stats!.total, null),
                      _buildFilterChip('En attente', _stats!.byStatus[AppointmentStatus.PENDING] ?? 0, AppointmentStatus.PENDING),
                      _buildFilterChip('Confirmé', _stats!.byStatus[AppointmentStatus.CONFIRMED] ?? 0, AppointmentStatus.CONFIRMED),
                      _buildFilterChip('Terminé', _stats!.byStatus[AppointmentStatus.COMPLETED] ?? 0, AppointmentStatus.COMPLETED),
                    ],
                  ),
                ),
                        ...
                        const PopupMenuItem<String>(
                          ...
                          child: Row(
                            children: [
                              ...
                              SizedBox(width: 12),
                              Text('Accepter', style: TextStyle(color: Color(0xFF7DDAB9), fontWeight: FontWeight.w600)),
                            ],
                          ),
                        ),
                      );
                        ...
                        const PopupMenuItem<String>(
                          ...
                          child: Row(
                            children: [
                              ...
                              SizedBox(width: 12),
                              Text('Refuser', style: TextStyle(color: Color(0xFFFF6B6B), fontWeight: FontWeight.w600)),
                            ],
                          ),
                        ),
                      );
                        ...
                        const PopupMenuItem<String>(
                          ...
                          child: Row(
                            children: [
                              ...
                              SizedBox(width: 12),
                              Text('Modifier', style: TextStyle(color: Color(0xFF9BC4E2), fontWeight: FontWeight.w600)),
                            ],
                          ),
                        ),
                      );
                      ...
                      const PopupMenuItem<String>(
                        ...
                        child: Row(
                          children: [
                            ...
                            SizedBox(width: 12),
                            Text('Supprimer', style: TextStyle(color: Color(0xFFFF6B6B), fontWeight: FontWeight.w600)),
                          ],
                        ),
                      ),
                    );
                      ...
                      const PopupMenuItem<String>(
                        ...
                        child: Row(
                          children: [
                            ...
                            SizedBox(width: 12),
                            Text('Voir les détails', style: TextStyle(color: Color(0xFF718096))),
                          ],
                        ),
                      ),
                    );
                      ...
                      const PopupMenuItem(
                        ...
                        child: Row(
                          children: [
                            ...
                            SizedBox(width: 12),
                            Text('Annuler', style: TextStyle(color: AppColors.critical)),
                          ],
                        ),
                      ),
                    const PopupMenuItem(
        ...
        const SnackBar(
          content: Row(
            children: [
              ...
              SizedBox(width: 12),
              Text('Rendez-vous accepté avec succès'),
            ],
          ),
  ...
  Future<void> _cancelAppointment(String appointmentId) async {
    ...
    if (confirm == true) {
      try {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Rendez-vous annulé'), backgroundColor: Colors.orange),
        );
        _loadAppointments();
      } catch (e) {
        ScaffoldMessenger.of(context).showSnackBar(
  ...
  Future<void> _deleteAppointment(String appointmentId) async {
    final confirm = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text('Êtes-vous sûr de vouloir supprimer définitivement ce rendez-vous ? Cette action est irréversible.'),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context, false),
            child: const Text('Non'),
    ...
    if (confirm == true) {
      try {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Rendez-vous supprimé définitivement'), backgroundColor: Colors.red),
        );
        _loadAppointments();
      } catch (e) {
        ScaffoldMessenger.of(context).showSnackBar(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                // Status Selection
                const Text('Statut *', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 14)),
                const SizedBox(height: 8),
                Wrap(
                  spacing: 8,
                  runSpacing: 8,
                ...
                // Date & Time Picker
                const Text('Date et heure *', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 14)),
                const SizedBox(height: 8),
                GestureDetector(
                  onTap: () async {
                ...
                const Text('Type de rendez-vous *', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 14)),
                const SizedBox(height: 8),
                Row(
                  children: [
                    Expanded(
                ...
                Column(
                  ...
                  children: [
                    TextField(
                      ...
                      decoration: InputDecoration(
                        labelText: selectedPatientId == null ? 'Rechercher un patient *' : 'Patient sélectionné',
                        hintText: selectedPatientId == null ? 'Rechercher par nom ou email...' : selectedPatientName,
                    ...
                    onPressed: isCreating
                        ...
                        : () async {
                            ...
                            if (selectedPatientId == null || selectedPatientId!.isEmpty) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text('Veuillez sélectionner un patient dans les résultats'),
                            ...
                            try {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text('Rendez-vous créé avec $selectedPatientName !'),
                                  backgroundColor: Colors.green,
                                ),
                              );
                              ...
                              String errorMessage = 'Échec de la création du rendez-vous';
                              if (e.toString().contains('Serveur inaccessible')) {
                                ...
                                errorMessage = 'Patient introuvable. Veuillez sélectionner un patient valide.';
