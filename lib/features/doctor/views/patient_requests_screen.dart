...
class _PatientRequestsScreenState extends State<PatientRequestsScreen> {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('${request.patientId.fullName} accepté(e) comme patient'),
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            Text('Refuser la demande de ${request.patientId.fullName} ?'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Demandes de Patients'),
        actions: [
          IconButton(
