...
class _PatientRequestsScreenState extends State<PatientRequestsScreen> {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              '${request.patientId.fullName} accepted as a patient',
            ),
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Text(
                                      '${_requests.length} New request${_requests.length > 1 ? "s" : ""}',
  ...
  Widget _buildRequestCard(PatientRequestModel request) {
    ...
    final initial = patient.prenom.isNotEmpty
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [
                  const Color(0xFF22C1C3).withAlpha(25),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: const LinearGradient(
                      ...
                      colors: [Color(0xFF22C1C3), Color(0xFF9BC4E2)],
                    ),
                    borderRadius: BorderRadius.circular(20),
                    boxShadow: [
                      BoxShadow(
                        color: const Color(0xFF22C1C3).withAlpha(60),
                        blurRadius: 12,
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          if (request.urgentNote != null &&
                              request.urgentNote!.isNotEmpty)
                            Container(
                              padding: const EdgeInsets.symmetric(
                                horizontal: 10,
                                vertical: 6,
                  ...
                  Row(
                    children: [
                      Container(
                        padding: const EdgeInsets.all(8),
                        decoration: BoxDecoration(
                          color: const Color(0xFF22C1C3).withAlpha(25),
                          borderRadius: BorderRadius.circular(10),
                        ),
                        child: const Icon(
                ...
                Expanded(
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      padding: const EdgeInsets.symmetric(vertical: 16),
                      elevation: 0,
                      shadowColor: const Color(0xFF22C1C3).withAlpha(60),
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(16),
                      ),
                    ),
