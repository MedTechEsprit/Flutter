...
class _NotificationsInboxScreenState extends State<NotificationsInboxScreen> {
  ...
  List<Map<String, dynamic>> _sortLatestFirst(
  ...
  DateTime? _parseDate(Map<String, dynamic> item) {
    final raw = (item['createdAt'] ?? item['timestamp'] ?? item['date'] ?? '')
        .toString();
    return DateTime.tryParse(raw);
  }

  Map<String, dynamic> _extractNavigationData(
  ...
  Widget _buildHeader() {
    final canMarkAll = _unreadCount > 0 && !_isMarkAllLoading;
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              ...
              InkWell(
                onTap: canMarkAll ? _markAllAsRead : null,
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: Colors.white.withOpacity(canMarkAll ? 0.22 : 0.12),
                    borderRadius: BorderRadius.circular(12),
                  ),
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: isRead
                        ? Colors.transparent
                        : const Color(0xFF22C1C3).withOpacity(0.25),
                    width: 1.2,
                  ),
                ),
                child: Row(
