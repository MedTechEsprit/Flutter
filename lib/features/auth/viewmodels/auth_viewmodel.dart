    ...
    try {
      final googleSignIn = GoogleSignIn(
        ...
        serverClientId: ApiConstants.googleWebClientId.isNotEmpty
            ...
            : null, // Web Client ID for backend verification
      );
      ...
      if (idToken == null || idToken.isEmpty) {
        _errorMessage =
            'Token Google introuvable. Vérifiez la configuration OAuth.';
        _isLoading = false;
        notifyListeners();
        return false;
      }

      final response = await _authService.loginWithGoogleIdToken(idToken);
      ...
      _errorMessage = response.errorMessage ?? 'Connexion Google impossible';
      _isLoading = false;
      notifyListeners();
      return false;
    } catch (e) {
