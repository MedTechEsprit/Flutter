...
/// Écran d'inscription pour les médecins
...
class _RegisterMedecinScreenState extends State<RegisterMedecinScreen> {
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildTextField(_adresseCabinetController, 'Adresse du cabinet (optionnel)', Icons.location_on, isRequired: false),
                          const SizedBox(height: 16),

                          _buildTextField(_hopitalController, 'Hôpital/Clinique (optionnel)', Icons.local_hospital, isRequired: false),
                          const SizedBox(height: 24),
  ...
  Widget _buildRoleIndicator() {
    return Container(
      ...
      child: const Row(
        ...
        children: [
          Icon(Icons.medical_services, color: AppColors.lightBlue, size: 20),
          SizedBox(width: 8),
          Text('Médecin', style: TextStyle(color: AppColors.lightBlue, fontWeight: FontWeight.w600)),
        ],
      ),
    );
  }
  ...
  Widget _buildSpecialiteSelector() {
    return DropdownButtonFormField<String>(
      value: _specialiteController.text.isEmpty ? null : _specialiteController.text,
      decoration: InputDecoration(
      ...
      items: _specialites.map((spec) {
        return DropdownMenuItem(value: spec, child: Text(spec));
      }).toList(),
      onChanged: (value) => setState(() => _specialiteController.text = value ?? ''),
    ...
    return Row(
      ...
      children: [
        ...
        TextButton(
          ...
          child: const Text(
            'Se connecter',
            style: TextStyle(color: AppColors.lightBlue, fontWeight: FontWeight.w600),
          ),
        ),
      ],
    );
