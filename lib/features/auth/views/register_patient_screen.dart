...
class _RegisterPatientScreenState extends State<RegisterPatientScreen> {
  ...
  final List<String> _typesDiabete = ['Type 1', 'Type 2', 'Gestationnel', 'Autre'];
  ...
  Future<void> _handleRegister() async {
    ...
    if (result['success'] == true) {
      // Succès - afficher message et naviguer vers login
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // Téléphone (optionnel)
                          _buildTextField(_telephoneController, 'Téléphone (optionnel)', Icons.phone, isRequired: false),
                          const SizedBox(height: 16),
                          ...
                          // Type de diabète
                          _buildTypeDiabeteSelector(),
                          const SizedBox(height: 16),

                          // Adresse (optionnel)
                          _buildTextField(_adresseController, 'Adresse (optionnel)', Icons.location_on, isRequired: false),
                          const SizedBox(height: 24),
    ...
    return Container(
      ...
      child: const Row(
        ...
        children: [
          ...
          SizedBox(width: 8),
          Text('Patient', style: TextStyle(color: AppColors.softGreen, fontWeight: FontWeight.w600)),
        ],
      ),
    );
  }
          ...
          children: [
            ...
            Text(
              _dateNaissance != null
                  ...
                  : 'Date de naissance *',
              style: TextStyle(
                color: _dateNaissance != null ? AppColors.textPrimary : Colors.grey.shade600,
                fontSize: 16,
              ),
            ),
          ],
    ...
    return Row(
      children: [
        ...
        Expanded(
          child: Row(
            children: [
              _buildRadioOption('Homme', 'homme'),
              const SizedBox(width: 16),
              _buildRadioOption('Femme', 'femme'),
            ],
          ),
        ),
      ],
  ...
  Widget _buildTypeDiabeteSelector() {
    return DropdownButtonFormField<String>(
      value: _typeDiabete,
      decoration: InputDecoration(
        labelText: 'Type de diabète (optionnel)',
      ...
      items: _typesDiabete.map((type) {
        return DropdownMenuItem(value: type, child: Text(type));
      }).toList(),
      onChanged: (value) => setState(() => _typeDiabete = value),
    );
  }
    ...
    return Row(
      ...
      children: [
        ...
        TextButton(
          ...
          child: const Text(
            'Se connecter',
            style: TextStyle(color: AppColors.softGreen, fontWeight: FontWeight.w600),
          ),
        ),
      ],
    );
